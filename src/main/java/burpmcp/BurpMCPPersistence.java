...
public class BurpMCPPersistence {
    ...
    /**
     * Saves server configuration (host, port, toggles, and the one-time
     * Claude Code auto-prompt flag).
     */
    public void saveServerConfig(String host, int port, boolean crlfReplace, boolean mcpServerEnabled, boolean claudeCodeAutoPrompted) {
        saveServerConfig(host, port, crlfReplace, mcpServerEnabled, claudeCodeAutoPrompted, false);
    }

    public void saveServerConfig(String host, int port, boolean crlfReplace, boolean mcpServerEnabled, boolean claudeCodeAutoPrompted, boolean autoSaveInScope) {
        ...
        configObj.setBoolean("claudeCodeAutoPrompted", claudeCodeAutoPrompted);
        configObj.setBoolean("autoSaveInScope", autoSaveInScope);
    }

    /**
     * Restores server configuration.
     *
     * @return Object array containing [host, port, crlfReplace, mcpServerEnabled, claudeCodeAutoPrompted]
    ...
    public Object[] restoreServerConfig() {
        ...
        Boolean claudeCodeAutoPrompted = configObj.getBoolean("claudeCodeAutoPrompted");

        Boolean autoSaveInScope = configObj.getBoolean("autoSaveInScope");

        return new Object[] {
                host,
                port,
                crlfReplace != null ? crlfReplace : false,
                mcpServerEnabled != null ? mcpServerEnabled : false,
                claudeCodeAutoPrompted != null ? claudeCodeAutoPrompted : false,
                autoSaveInScope != null ? autoSaveInScope : false
        };
    }
